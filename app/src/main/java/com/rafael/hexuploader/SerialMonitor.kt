...
class SerialMonitor(
    ...
    // Um executor novo por instância — precisa ser desligado em stop(),
    // senão cada ciclo de abrir/fechar o monitor deixa uma thread presa.
    ...
    fun stop() {
        ioManager?.stop()
        ioManager = null
        // Libera a thread do executor — sem isso, cada SerialMonitor criado
        // (um por vez que o usuário abre o monitor) vaza uma thread parada.
        executor.shutdown()
    }
